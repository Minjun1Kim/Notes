...
-   Explains desired functionality
-   Crucial part of Agile process
-   Enables conversation and foster collaboration between the dev team and customer.

User stories put user at the centre of the conversation. <br>
User stories provide non-technical context for the development team and their efforts.

Difference between Traditional Requirement and User Story
- Traditional Requirment: written from a system's perspective.
```
A system should be able to do this or allow this, etc.
```
- User story: written from a user's perspective.
```
As a user, I want to be able to enter my email so that I can receive notification.
```
...
Examples
-   ```
    As a Piazza user, I would like the ability to message the instructor directly
    so that I can get one on one help for any questions or advice that I need.
    ```

-   ```
    As a Quercus instructor, I would like the ability to edit lectures
    so that I can keep the course accurate and up-to-date.
    ```


## 1.3. User Personas
Helps visualize the type of person that might be using the product.
A short description or biographies of fictitious, hypothetical customer.
Includes the following:
-   Name, Photo, Age, Gender
-   Personality
-   Skills
-   Environment (geographical/socioeconomic demographics)
...
```
    ...
    - Likes to read
```
## 1.4. Splitting by CRUD Functionality

Split by operations <br>
C = CREATE <br>
R = READ <br>
U = UPDATE <br>
D = DELETE
